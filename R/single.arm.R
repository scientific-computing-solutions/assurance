...
setClass("singleArmInitialData",
         representation(num.success="numeric",
                        total.num="numeric",
                        shape1="numeric",
                        shape2="numeric"),
...
setMethod("samplePosterior",
          signature(earlyStudy="singleArmInitialData",
                    nsim="numeric"),
...
setClass("singleArmLater",
         representation(success.count="numeric",
